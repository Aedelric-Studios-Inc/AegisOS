...
s64 sys_spawn(u64 path_ptr, u64 flags, u64 a2, u64 a3, u64 a4, u64 a5) {
    (void)a2; (void)a3; (void)a4; (void)a5;
    if (!path_ptr) return AEGIS_EINVAL;
    return userland_request_process_launch_by_path((const char *)(uptr)path_ptr, flags);
}
...
s64 sys_getppid(u64 a0, u64 a1, u64 a2, u64 a3, u64 a4, u64 a5) {
    (void)a0; (void)a1; (void)a2; (void)a3; (void)a4; (void)a5;
    /* No live userspace parent table yet; kernel/bootstrap context is parent 0. */
    return 0;
}

s64 sys_gettid(u64 a0, u64 a1, u64 a2, u64 a3, u64 a4, u64 a5) {
    (void)a0; (void)a1; (void)a2; (void)a3; (void)a4; (void)a5;
    /* Scheduler TID exposure arrives after true multi-task EL0 scheduling. */
    return 0;
}

s64 sys_service_id(u64 name_ptr, u64 a1, u64 a2, u64 a3, u64 a4, u64 a5) {
    (void)a1; (void)a2; (void)a3; (void)a4; (void)a5;
    if (!name_ptr) return AEGIS_EINVAL;
    u32 id = userland_feature_id_by_name((const char *)(uptr)name_ptr);
