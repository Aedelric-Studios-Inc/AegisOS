...
/// PID 1 only spawns the service manager.
///
/// Everything else belongs in /etc/services.toml so there is one service
/// truth table instead of hard-coded services fighting the runtime config.
