...
if ! grep -Eq 'AegisOS-v2\.0-v55(\.1-interactive-runtime|-release-img)' VERSION; then
  echo "VERSION is not a v55/v55.1 release lineage marker" >&2
  exit 2
fi
echo "v55 milestone guard: OK ($(cat VERSION))"
